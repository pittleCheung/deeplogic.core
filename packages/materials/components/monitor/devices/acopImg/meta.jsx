...
import warn from '../__deviceImg__/空压螺杆机报警.gif';
import fault from '../__deviceImg__/空压螺杆机故障.gif';
import run from '../__deviceImg__/空压螺杆机运行.gif';
import defaultI from '../__deviceImg__/空压螺杆机默认.png';
import screenshot from '../__screenshots__/Image_thumbnail.png';

export default {
  componentName: 'AcopImgGif',
  category: '数据展示',
  title: '空压机',
  screenshot,
  isDevice: true,
