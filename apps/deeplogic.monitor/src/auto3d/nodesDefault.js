...
export const root = {
  ...
  props: {
    ...
    style: {
      ...
      margin: 0,
      background:
        "url(/_api/tfile/Q_HGofj55Lc0MwMOAwxklr) 50% 50% / 100% 100% no-repeat,linear-gradient(rgba(27, 91, 153, 1), rgba(27, 91, 153, 1))",
      borderRadius: 0,
      backgroundList: [
        {
          id: "EKzxxXgFQm",
  ...
  G27xfLlinZ: {
    ...
    props: {
      ...
      style: {
        ...
        marginTop: 0,
        background:
          "url(/_api/tfile/tpWrCQK4yROnt3bSnXenLy) 50% 50% / 100% 100% no-repeat",
        backgroundList: [
          {
            id: "DuWRW3ln4I",
            type: "image",
...
export const chl_Out = (result, index, tag, current, item, CHLS) => {
  ...
  if (index === 0) {
    ...
    pipeh2.props.style = {
      ...
      translateY: fix(
        pipeh3.props.style.translateY + pipeh3.props.style.height / 3 - 3,
      ),
  ...
  if (!!tag) {
    ...
    pipeh3.props.style = {
      ...
      translateY: fix(
        connect.translateY + styleMap["w"].height + styleMap.h.height * 0.5 + 5,
      ),
    }
    result[pipeh3.id] = pipeh3
  }
...
export const pump_chl = (item, result, type, init, dType, pipeType, index) => {
  ...
  for (let i = 0; i < item.length; i++) {
    ...
    if (Math.abs(vnum) > 0 && dType !== "tower") {
      ...
      const pipvArr = [
        ...item.slice(0, i),
        ...item.slice(i + 1, item.length),
      ]?.map((t) => deviceIdsMapValue[t])
      const total =
        dType === "tower" || dType === "tower_pump"
      ...
      if (type === "chw" && dType !== "tower") {
        ...
        connWchw.props.style = {
          ...
          translateY:
            ...
            styleMap["w"].height * 0.5,
          translateX:
            pipev1.props.style.translateX - styleMap["w"].width * 0.5 + 2,
          rotate: 90,
        }
  ...
  for (let i = 0; i < item.length; i++) {
    ...
    if (i == 0) {
      ...
      connW.props.style = {
        ...
        translateY:
          pipeh1.props.style.translateY - styleMap["w"].height / 2 + 3,
      }
      result[connW.id] = connW
      ...
      connW.props.style = {
        ...
        translateX:
          pipeh1.props.style.translateX +
          pipeh1.props.style.width +
          styleMap["w"].width * 0.5,
        translateY:
          pipeh1.props.style.translateY + 50 - styleMap["w"].height * 0.5,
        rotate: 180,
      }
      result[connW.id] = connW
      result[pipeh2.id] = pipeh2
  ...
  for (let i = 0; i < item.length; i++) {
    ...
    if (i === 0) {
      ...
      connW2.props.style = {
        ...
        translateX: fix(pipev.props.style.translateX - styleMap.v.width * 0.5),
        translateY:
          fix(pipev.props.style.translateY - styleMap["w"].height) + 4,
        rotate: 270,
      }
      result[pipev.id] = pipev
      result[connW2.id] = connW2
