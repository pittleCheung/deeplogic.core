...
const efficiencyTab = (parentid, source, tag) => {
  ...
  return {
    ...
    "23QzGz-y2q": {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["P_qeNHeIlb", "pC99J0R3lu", "a-Ex5Ukuyh"],
      linkedNodes: {},
    },
    P_qeNHeIlb: {
      type: {
    ...
    wXdPhSCitj: {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["i-P8asrp5U", "1Y133yS6xT", "1K3DfyHX9M"],
      linkedNodes: {},
    },
    "i-P8asrp5U": {
      type: {
    ...
    zcAz3tuKp_: {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["SGOfPX7_dE", "iEPayRloE5", "M0mIxYXins"],
      linkedNodes: {},
    },
    SGOfPX7_dE: {
      type: {
    ...
    pDjq40AL8X: {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["dXHcX3-e17", "-wR_zqWU2U", "aQcpccMEHk"],
      linkedNodes: {},
    },
    "dXHcX3-e17": {
      type: {
    ...
    eqGr_o4d0r: {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["YtoF3Ycx0y", "1hf0xBOe73", "rmjo2jBJuI"],
      linkedNodes: {},
    },
    YtoF3Ycx0y: {
      type: {
    ...
    "n0TzbNA-cV": {
      ...
      parent: "WjE5WGRXQ8",
      hidden: false,
      nodes: ["twZnMhcZpk", "uQvXtg25Mj", "syQi1VakX8"],
      linkedNodes: {},
    },
    twZnMhcZpk: {
      type: {
...
export const pageLayout = (parentid, source, tag) => {
  ...
  const ariMap = arimap()
  // 优化边界设置
  const setting = Array(tag ? ariMap[2]?.length : 7)
    .fill(1)
    .map((_, i) => {
      return drawthree(settingparent, tag ? ariMap[2]?.[i] : drawMap[i], source)
    })
  // 参数开关
  const open = Array(tag ? ariMap[1]?.length : 7)
    .fill(1)
    .map((_, i) => {
      return drawtwo(openparent, tag ? ariMap[1]?.[i] : drawMap[i], source)
    })
  // 参数控制
  const control = Array(tag ? ariMap[0]?.length : 7)
    .fill(1)
    .map((_, i) => {
      return drwacontrol(
        controlparent,
        tag ? ariMap[0]?.[i] : drawMap[i],
        source,
      )
    })
  ...
  return {
    ...
    [drawerbtnid]: {
      ...
      props: {
        ...
        style: {
          ...
          borderImage:
            "linear-gradient(66deg, rgba(255, 255, 255, 0.19) 3%, rgba(255, 255, 255, 0.02) 95%)",
          width: "64px",
          height: "42px",
          marginTop: 16,
        },
    ...
    [tab2]: {
      ...
      custom: {},
      parent: drawercontentchildid,
      nodes: [settingparent, openparent],
      linkedNodes: {},
      hidden: false,
      isCanvas: true,
    },
    ...
    [settingparent]: {
      ...
      custom: {},
      parent: tab1,
      nodes: ["q2CmQjoNPn", "Zbkajfwp-F", ...setting?.map((t) => t.id)],
      linkedNodes: {},
      hidden: false,
      isCanvas: true,
    },
    [openparent]: {
      ...
      custom: {},
      parent: tab2,
      nodes: ["Kfe6Qygbt1", "CeAzrInI_q", ...open?.map((t) => t.id)],
      linkedNodes: {},
      hidden: false,
      isCanvas: true,
    },
    ...
    "Zbkajfwp-F": {
      ...
      custom: {},
      parent: settingparent,
      nodes: ["JVA9eTa-9g", "LE6jzWVNDz", "8J65JMXvkS"],
      linkedNodes: {},
      hidden: false,
      isCanvas: true,
    },
    ...
    [controlparent]: {
      ...
      custom: {},
      parent: tab1,
      nodes: ["NrvCv6U4Dm", "LHbHuHR2aE", ...control?.map((t) => t.id)],
      linkedNodes: {},
      hidden: false,
      isCanvas: true,
    },
        ...
        status: [
          {
            ...
            expression: {
              ...
              type: "expressions",
              point: [source.ONECLICK_START?.NAME],
            },
            // "color": "transparent"
          },
          {
        ...
        status: [
          {
            ...
            expression: {
              ...
              type: "expressions",
              point: [source.ONECLICK_STOP?.NAME],
            },
            // "color": "transparent"
          },
          {
    ...
    LHbHuHR2aE: {
      ...
      parent: "ROOT",
      hidden: false,
      nodes: ["2a1_jDAqHs", "VPlbKn2dWO", "pv3jOlEtY5"],
      linkedNodes: {},
    },
    "2a1_jDAqHs": {
      type: {
