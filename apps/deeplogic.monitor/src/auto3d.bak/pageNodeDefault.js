...
export const rootPointAirMap = (source) => {
  return {
    ...
    [source?.["R_AIR_COMP"]?.NAME]: 0,
    [source?.["P_PLANT"]?.NAME]: 0,
    [source?.["PR_DISCHARGE"]?.NAME]: 0,
    [source?.["T_DISCHARGE"]?.NAME]: 0,
    [source?.["PR_PLANT"]?.NAME]: 0,
    [source?.["T_DEW"]?.NAME]: 0,
    [source?.["FLOW_PLANT_AIR"]?.NAME]: 0,
  }
}
...
export const arimap = (source) => {
  return [
    [
      ...
      {
        name: "空压机频率(Hz)",
        point4: source?.["FREQ_ACOP_SP"]?.NAME || "FREQ_ACOP_SP",
        val: source?.["FREQ_ACOP"]?.NAME || "FREQ_ACOP",
      },

      {
        name: "目标压差(Mpa)",
        point4: source?.["DPR_SP"]?.NAME || "DPR_SP",
        val: source?.["DPR"]?.NAME || "DPR",
      },
      //  {
      //     name: '空压机排气温度(℃)',
    ...
    [
      ...
      {
        name: "空压机启停",
        point3: source?.["ADDSUB_ACOP_OPT_EB"]?.NAME || "ADDSUB_ACOP_OPT_EB",
      },
      {
        name: "空压机加减载",
        point3: source?.["LOAD_ST_OPT_EB"]?.NAME || "LOAD_ST_OPT_EB",
      },
      // {
      //     name: '冷却塔频率',
      //     point3: source?.['FREQ_CT_OPT_EB']?.NAME || 'FREQ_CT_OPT_EB'
    ...
    [
      ...
      {
        name: "空压机加载压力(Mpa)",
        point2: source?.["PR_LOAD_MIN"]?.NAME || "PR_LOAD_MIN",
        point1: source?.["PR_LOAD_MAX"]?.NAME || "PR_LOAD_MAX",
      },
      {
        name: "空压机卸载压力(Mpa)",
        point2: source?.["PR_UNLOAD_MIN"]?.NAME || "PR_UNLOAD_MIN",
        point1: source?.["PR_UNLOAD_MAX"]?.NAME || "PR_UNLOAD_MAX",
      },
      {
        name: "空压机排气压力(Mpa)",
        point2: source?.["PR_DISCHARGE_MIN"]?.NAME || "PR_DISCHARGE_MIN",
        point1: source?.["PR_DISCHARGE_MAX"]?.NAME || "PR_DISCHARGE_MAX",
      },
      {
        name: "空压机频率(Hz)",
      ...
      {
        name: "目标压差(Mpa)",
        point2: source?.["DPR_MIN"]?.NAME || "DPR_MIN",
        point1: source?.["DPR_MAX"]?.NAME || "DPR_MAX",
      },
      // {
      //     name: '空压机频率(Hz)',
      //     point2: source?.['FREQ_ACOP_MIN']?.NAME || 'FREQ_ACOP_MIN',
        ...
        props: {
          value: source?.[drawitem.point2]?.NAME
            ? {
                ...
                type: "points",
                point: [source?.[drawitem.point2]?.NAME],
              }
            : "",
          displayName: "InputKb",
          size: "middle",
        ...
        props: {
          value: source?.[drawitem.point1]?.NAME
            ? {
                ...
                type: "points",
                point: [source?.[drawitem.point1]?.NAME],
              }
            : "",
          displayName: "InputKb",
          size: "middle",
      ...
      [boxclo2]: {
        ...
        props: {
          value: {
            ...
            type: "points",
            point: [source[drawitem.point3]?.NAME],
          },
          label: "开启",
          options: [],
          events: {
...
export const drwacontrol = (parentid, drawitem, source) => {
  ...
  console.log(
    "source[drawitem.val]?.NAMEsource[drawitem.val]?.NAME",
        ...
        props: {
          value: source[drawitem.point4]?.NAME
            ? {
                ...
                type: "points",
                point: [source[drawitem.point4]?.NAME],
              }
            : "",
          displayName: "InputKb",
          size: "middle",
        ...
        props: {
          ...
          value: source[drawitem.val]?.NAME
            ? {
                ...
                type: "points",
                point: [source[drawitem.val]?.NAME],
              }
            : 0,
          level: "5",
          size: "14px",
